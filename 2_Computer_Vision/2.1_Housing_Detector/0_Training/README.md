...
![VoTT Houses](/2_Computer_Vision/2.1_Housing_Detector/0_Training/VoTT_Houses.png)

 Once you are done, export the project. 
 
![VoTT Saving](/2_Computer_Vision/2.1_Housing_Detector/0_Training/VoTT_Save.png)
...
![VoTT Folder](/2_Computer_Vision/2.1_Housing_Detector/0_Training/VoTT_Export.jpg)
