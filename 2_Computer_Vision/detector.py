...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        dest="anchors_path",
        default="src/keras_yolo3/model_data/yolo_anchors.txt",
