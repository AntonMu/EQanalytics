...
houses_file = os.path.join(
    data_folder, "House_Detection_Results", "Housing_Results.csv"
)

cropping_result_folder = os.path.join(data_folder, "House_Cropping_Results")
cropping_result_file = os.path.join(
    data_folder, "House_Cropping_Results", "Cropping_Results.csv"
)

houses_classes = os.path.join(
    data_folder, "Model_Weights", "Houses", "data_classes.txt"
)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--output_folder",
        type=str,
        default=cropping_result_folder,
    ...
    crop_and_save(
        image_df,
        target_path=FLAGS.output_folder,
        target_file=FLAGS.output_file,
