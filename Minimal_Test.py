...
sys.path.append(os.path.join(os.path.dirname(os.path.abspath(__file__)),'2_Computer_Vision','src'))
...
cropping_script = os.path.join(os.path.dirname(os.path.abspath(__file__)),'2_Computer_Vision','Crop_Images.py')
...
classifier_script = os.path.join(os.path.dirname(os.path.abspath(__file__)),'3_Classification','Classifier.py')
