...
arglist = [
    ["input_images", street_view_folder],
    ["classes", houses_classes],
    ["output", test_folder],
    ["yolo_model", houses_weights],
    ["box_file", houses_result_file],
    ["anchors", anchors],
]
...
arglist = [
    ["input_file", houses_result_file],
    ["classes", houses_classes],
    ["output_folder", cropped_folder],
    ["output_file", cropping_result_file],
]
...
model_folder = os.path.join(data_folder, "Model_Weights")
opening_weights = os.path.join(
    model_folder,
    "Openings",
    "trained_weights_final.h5")
opening_classes = os.path.join(
    model_folder,
    "Openings",
    "data_all_classes.txt")
...
arglist = [
    ["input_images", cropped_folder],
    ["classes", opening_classes],
    ["output", test_folder],
    ["yolo_model", opening_weights],
    ["box_file", openings_result_file],
    ["anchors", anchors],
    ["postfix", "_opening"],
]
call_string = " ".join(["python", detector_script, make_call_string(arglist)])
...
arglist = [
    ["output_file", softness_score_file],
    ["input_file", openings_result_file],
    ["level_folder", test_folder],
    ["classes", opening_classes],
]

call_string = " ".join(
    ["python", classifier_script, make_call_string(arglist)])
